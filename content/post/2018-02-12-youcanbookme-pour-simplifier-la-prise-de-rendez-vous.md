...
J'ai créé un script AppleScript qui tourne à intervalle régulier et qui copie les rendez-vous des autres calendriers dans le calendrier réservé à YouCanBookMe. Ce script fonctionne malgré le nombre assez hallucinant de bugs qu'Apple a laissé dans l'implémentation d'AppleScript de Calendar (Calendrier), et qui imposent parfois d'utiliser des solutions de contournement assez bizarres.
